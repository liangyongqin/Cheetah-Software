...
private:
  ...
  Array4i _offsets; // offset in mpc segments 分段中的偏移量
  Array4i _durations; // duration of step in mpc segments 分段中step的持续时间
  Array4f _offsetsFloat; // offsets in phase (0 to 1) 腿之间相位补偿(0至1)
  Array4f _durationsFloat; // durations in phase (0 to 1) 相位持续时间(0到1)
